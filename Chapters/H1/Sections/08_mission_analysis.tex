...
\rfig{orbits}{0.3}{Juno's trajectory from ecliptic north pole}
...
The fly-by around Earth occurred on the $10^{th}$ of September 2013 and puts the spacecraft on its final trajectory to Jupiter. Particularly, the fly-by gave the spacecraft 7.3 km/s, avoiding a fire-up of the Leros 1-b main engine of Juno. A last correction maneuver was performed to refine Juno's trajectory.
...
% dopo quanti perigiove non è successa la PRM, safety modes 
% cambiamenti orbite per longitudini
% puntamento diverso degli strumenti 
% cambio di strategie e cambio piano per eclipse avoidance, progetto robusto ( mission extended anal )
% cosa facciamo nella extended: flyby sulle diverse lune e analisi anelli 

\subsection{Mission disposal}
\label{sec: disposal}

% per evitare contaminations of environment
