...
\begin{enumerate}
    \item \textbf{How did Jupiter form and influence the solar system? } \cite{2006_overview} \cite{video_1h}\\ %video e junolaunch
    ...
    \item \textbf{What's the structure of Jupiter's atmosphere?}  \cite{Juno_mission}\cite{video_1h} \\ % the juno mission
    ...
    \item \textbf{What do auroras look like and what are the physical processes generating them?}  \cite{Juno_mission} \cite{video_1h}\\ % the juno mission, juno launch 
    ...
    \item \textbf{What do the poles look like?} \cite{video_1h}\\ % the juno mission, juno launch, spaceflight 101
    \label{goal 5}
