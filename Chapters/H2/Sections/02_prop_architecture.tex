...
\cfig{spin2}{0.75}{Forward and Aft deck view}

\rfig{architettura_prop}{0.6}{Propulsion system architecture}
...
% \rfig{architettura_prop}{0.4}{Propulsion system architecture}
