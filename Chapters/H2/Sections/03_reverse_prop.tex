...
\begin{enumerate}[itemsep=5mm]
    ...
    \begin{gather}
        ...
        \label{eq:ox_mass}
    \end{gather}
    The estimated masses are rather similar to the real ones, as it can be seen in \autoref{table:materials}
