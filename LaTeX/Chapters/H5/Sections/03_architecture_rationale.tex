...
\begin{itemize}
    ...
    The Germanium coated Kapton used to cover the antenna dish has an operating range temperature of -200°C $\div$ +200°C and a absorptivity to emissivity ratio value of $\alpha / \epsilon \approx $ 0.63\mref.
    ...
    (da aggiungere qualcosa su vault interno)
    \item main body
    \item solar panels
\end{itemize}
