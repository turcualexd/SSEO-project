...
In order to retrieve data, Juno relies on the antennas of NASA's DSN, a system of three complexes spread around the globe, separated by approximately 120°: one is located in Goldstone, California; one in Madrid, Spain, and one in Canberra, Australia. This configuration allows for constant observation of spacecraft while Earth rotates\cite{juno_telecommunication}.
