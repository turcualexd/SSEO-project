...
JOI, which was obtained through a main engine burn, was made at the closest approach to Jupiter: this moment is called PJ-0, indicating the first passage at the perijove of Juno. The targeted point for this maneuver is at an altitude of 4200 km, calculated above the 1-bar level of Jupiter. 
JOI burn was timed to happen in the area of minimum magnetic field strength, reducing the risk of hardware damage during such a critical manoeuvre. The spacecraft is left on a highly elliptical 53-days period around Jupiter with and inclination of 90\textdegree \; ($\pm$10\textdegree). Additional clean-up manuevers were planned to correct the trajectory. The attitude during JOI phase, as the spacecraft was slowing down, was such that the HGA was not pointing Earth, constraining communications to low tones, only meant to send information about the completion or failure of the events. 
