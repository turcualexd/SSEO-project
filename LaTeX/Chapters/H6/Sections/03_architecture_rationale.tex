...
The central bus supplies all the loads which are then self-regulated in order to generate the required tension and current. This is particularly true for the P/L subsystem in which every instrument have high voltage request or the need to be supplied by AC. 
