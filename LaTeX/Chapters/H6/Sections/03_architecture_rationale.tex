...
%% magari una tabella con lunghezza di ogni stringa e quando vengono usate ?


% queste frasi non mi piacciono proprio sistemo domani mattina



% In fact, available power and voltage depend on the external environment, respectively to temperature and distance from the Sun in an inversely proportional way. 
